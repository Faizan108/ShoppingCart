...
import com.practice.ShoppingCart.service.Order.IOrderService;
...
public class OrderController {
    ...
    public ResponseEntity<ApiResponse> placeOrder(@RequestParam Long userId){
        ...
        try{
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(new ApiResponse("Exception Occured",e.getMessage()));
        }
    }
    ...
    public ResponseEntity<ApiResponse> getUserOrder(@PathVariable Long userId){
        ...
        try{
            ...
            return ResponseEntity.ok(new ApiResponse("Order retrieved successfully", userOrder));
        }catch(ResourceNotFoundException e){
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(new ApiResponse("Order Not Found",e.getMessage()));
        }
